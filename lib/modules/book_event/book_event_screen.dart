...
class BookEventScreen extends GetView<BookEventController> {
  const BookEventScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(appBarTitleText: keyBookEvent.tr, actionWidget: [
        AssetImageWidget(
   ...
   showDatePickerModal(BuildContext context) async {
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return Container(
          ...
          child: Column(
            children: [
              Container(height: 4.h, width: 40.w, margin: EdgeInsets.only(bottom: 10.h), decoration: BoxDecoration(color: AppColors.containerBorderGreyColor, borderRadius: BorderRadius.circular(2.r))),
              Text(selectTime.tr, style: textStyleBodyLarge().copyWith(fontWeight: FontWeight.w700,fontSize: 20.sp,color: AppColors.primaryTextColor)),
              Expanded(
                child:Stack(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColors.containerGreyColor, // subtle background
                    ...
                    TimePickerSpinner(
                      is24HourMode: false,
                      normalTextStyle: textStyleBodyLarge().copyWith(fontWeight: FontWeight.w700,fontSize: 18.sp,color: AppColors.secondaryTextColor),
                      highlightedTextStyle:  textStyleBodyLarge().copyWith(fontWeight: FontWeight.w700,fontSize: 18.sp,color: AppColors.appColor),
                      spacing: 50.w,
                      itemHeight: 50.h,
                      isForce2Digits: true,
                      time: DateTime(0, 0, 0, tempTime.hour, tempTime.minute),
                      onTimeChange: (time) {
                        tempTime = TimeOfDay.fromDateTime(time);
                      },
                    ),
                  ],
                )
        ...
        child: Obx(
          ()=>controller.isLoading.value?ShimmerEffect.eventShimmer(): Column(
            ...
            children: [
              ...
              _bookStaffField(title: keyStaff.tr, icon: AssetImageWidget( AppImages.iconsMemberIcon)),
              ...
              PrimaryBottomButton(callBack: (){controller.bookEventApi(); }, title: keyBook.tr)
            ],
          ),
        ),
      ).paddingAll(20.h);
  ...
  _bookStaffField({required String title,required Widget icon }) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title,style:textStyleDisplayLarge().copyWith(color: AppColors.primaryTextColor,fontWeight: FontWeight.w500,fontSize: 16.sp),),
        ...
        Obx(
              () {
            controller.resourceList.length;
            return CustomDropdown2<Staff>(dropdownItems:controller.staffListResponse,
              onChanged: (I) {
                controller.selectedStaff.value = I;
              },
              radius: 6.r,
              prefixIcon: icon,
            );
        ...
        decoration: BoxDecoration(
          ...
          child: Obx(
              ...
              children: [
                ...
                Obx(()=> Text(controller.selectedDate.value.toString().isNotEmpty?controller.selectedDate.value.toString():keySelect.tr,style: textStyleBodySmall(),)),
              ],
            ),
          )),
      ...
      child:Container(
          ...
          child: Obx(
              ...
              children: [
                ...
                Obx(()=> Text(controller.selectedTime.value.toString().isNotEmpty?controller.selectedTime.value.toString():keySelect.tr,style: textStyleBodySmall(),)),
              ],
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      selected?.firstName ??keySearchMember.tr,
